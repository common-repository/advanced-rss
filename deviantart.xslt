                ...
                <li>
                    ...
                    <xsl:if test="$mode = 'full'">
                        ...
                        <xsl:element name="div">
                            ...
                            <xsl:value-of select="media:description" disable-output-escaping="yes" />
                        </xsl:element>
                    </xsl:if>
                    <xsl:element name="a">
                        <xsl:attribute name="href">
                        ...
                        <xsl:element name="img">
                            <xsl:attribute name="src">
                                <xsl:if test="$mode != 'full'">
                                    <xsl:value-of select="media:thumbnail[last()]/@url" />
                                </xsl:if>
                                <xsl:if test="$mode = 'full'">
                                    <xsl:value-of select="media:thumbnail[1]/@url" />
                                </xsl:if>
                            </xsl:attribute>
